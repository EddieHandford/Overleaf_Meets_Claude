...
Branch names like \verb|claude/shorten-intro|, \verb|claude/reviewer-response-round-1|, or \verb|claude/notation-cleanup| keep work scoped and reversible. Merge via pull request when you are happy; you get free code review on prose.
